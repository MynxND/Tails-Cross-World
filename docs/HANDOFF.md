...
- Continue mapping recovered class skills to projectile/status values only where source evidence supports them; Sheep `cAttack` is the first completed projectile mapping, while neutral defaults remain for the other classes.
