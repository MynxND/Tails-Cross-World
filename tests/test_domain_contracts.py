...
VALID_DOCUMENTS = {
    ...
    "skill": {"skill_id": "skill.basic_slash", "character_id": "", "name_key": "skill.basic_slash.name", "animation_clip": "nAttack1", "damage": 10, "cooldown_seconds": 0.35, "hit_delay_seconds": 0.12, "hit_count": 1, "hit_interval_seconds": 0.0, "hit_times_seconds": [], "action_duration_seconds": 0.5, "combo_window_start_seconds": 0.25, "combo_window_end_seconds": 0.45, "combo_next_skill_id": "skill.power_strike", "resource_cost": 0, "range": 2.25, "target_shape": "sphere", "target_width": 0.0, "target_height": 0.0, "max_targets": 1, "projectile_speed": 0.0, "projectile_lifetime_seconds": 0.0, "projectile_homing_radians_per_second": 0.0, "impact_radius": 0.0, "status_effect_id": "", "status_duration_seconds": 0.0, "status_tick_seconds": 0.0, "status_damage_per_tick": 0, "status_movement_multiplier": 1.0},
